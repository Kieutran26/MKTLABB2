# Opti Engineer Prompt

> Nguồn gốc prompt: [services/optimki-prompt.ts](D:/MKTLABB2/services/optimki-prompt.ts)  
> Chỗ gọi thật trong runtime: [services/geminiService.ts:5658](D:/MKTLABB2/services/geminiService.ts:5658) và [services/geminiService.ts:5705](D:/MKTLABB2/services/geminiService.ts:5705)

---

## Prompt đang active hiện tại

Flow generate chính hiện tại dùng:

- User message: `buildOptimkiSingleShotUserMessage(input)`
- System instruction: `OPTIMKI_SINGLE_SHOT_SYSTEM_INSTRUCTION`

Flow render lại HTML dùng:

- User message: `buildOptimkiRenderUserMessage(payload)`
- System instruction: `OPTIMKI_PHASE2_SYSTEM_INSTRUCTION`

---

## Nguyên văn prompt file
